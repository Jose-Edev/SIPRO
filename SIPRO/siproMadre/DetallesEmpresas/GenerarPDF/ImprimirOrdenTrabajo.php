...
$partida = $bd->getPartidaByIdOt($id);
    ...
    <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">Generar PDF de Orden de Trabajo</h1>
        </div>
        ...
        <form id="form">
          <div class="table-responsive small">
            ...
            <div class="mb-3">
              ...
              <input type="date" class="form-control" id="fecha_elab" name="fecha_elab" value="<?php echo htmlspecialchars($requisicion_data['fecha_elab']); ?>">
            </div>
            ...
            <div class="mb-3">
              ...
              <input type="number" class="form-control" id="cantidad" name="cantidad" value="<?php echo htmlspecialchars($partida['cantidad']); ?>">
            </div>
            <br>
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="reporte_fotos" name="reporte_fotos" value="<?php echo htmlspecialchars($partida['reporte_fotos']); ?>">
            </div>
            <div class="mb-3">
              <label class="form-label label-large">Muestra</label>
              <input type="text" class="form-control" id="muestra" name="muestra" value="<?php echo htmlspecialchars($partida['muestra']); ?>">
            </div>
            <div class="mb-3">
              <label class="form-label label-large">Plano</label>
              <input type="text" class="form-control" id="plano" name="plano" value="<?php echo htmlspecialchars($partida['plano']); ?>">
            </div>
            <div class="mb-3">
              <label class="form-label label-large">Sobre Pieza</label>
              <input type="text" class="form-control" id="sobre_pieza" name="sobre_pieza" value="<?php echo htmlspecialchars($partida['sobre_pieza']); ?>">
            </div>
            <div class="mb-3">
              <label class="form-label label-large">Material</label>
              <input type="text" class="form-control" id="material" name="material" value="<?php echo htmlspecialchars($partida['material']); ?>">
            </div>
            <div class="mb-3">
              <label class="form-label label-large">Fecha de Entrega</label>
              <input type="date" class="form-control" id="fecha_entrega" name="fecha_entrega" value="<?php echo htmlspecialchars($partida['fecha_entrega']); ?>">
            </div>
