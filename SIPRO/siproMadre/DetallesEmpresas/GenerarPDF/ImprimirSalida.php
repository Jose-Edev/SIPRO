...
$partida = $bd->getPartidaByIdSa($partida_id);
if (empty($partida_id)) {
        ...
        <form id="form">
          <div class="table-responsive small">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="cliente" name="cliente" value="<?php echo htmlspecialchars($requisicion_data['cliente']); ?>">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="fecha_de_entrega" name="fecha_de_entrega" value="<?php echo htmlspecialchars($requisicion_data['fecha_de_entrega']); ?>">
            </div>
            <div class="mb-3">
              <label class="form-label label-large">Número de Salida</label>
              <input type="text" class="form-control" id="numero_de_salida" name="numero_de_salida" value="<?php echo htmlspecialchars($requisicion_data['numero_de_salida']); ?>">
            </div>
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="orden_de_trabajo" name="orden_de_trabajo" value="<?php echo htmlspecialchars($partida['orden_de_trabajo']); ?>">
            </div>
            <div class="mb-3">
              <label class="form-label label-large">Control de Calidad</label>
              <input type="text" class="form-control" id="control_de_calidad" name="control_de_calidad" value="<?php echo htmlspecialchars($partida['control_de_calidad']); ?>">
            </div>
