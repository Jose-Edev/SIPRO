...
$requisicion_data = $bd->getSalidas2($requisicion_id);
// Capturar el parámetro requisicion de la URL
$partidas = $bd->getPartidasByRequisicionId4($requisicion_id);
...
<head>
    ...
    <script src="../../../js/pdfOSs.js"></script>
  ...
  .offcanvas-body {
      height: 100%; /* Altura del 100% del viewport menos la altura del encabezado del sidebar */
    ...
    <div class="container-fluid">
        <div class="row">
            <div style="background-color: #141414;" class="border-left col-md-3 col-lg-2 p-0">
                <div style="width: auto; background-color: #141414;" class="offcanvas-md offcanvas-start me-3"
                    ...
                    <div class="offcanvas-header p-2" style="height: 50px; width: auto; background-color: #141414;">
                        <img src="../../../img/logoBlanco.png" alt="" width="25" height="25"
                        ...
                        <ul class="nav nav-pills flex-column">
                            ...
                            <li>
                                <a href="" style="background-color: red;"
                                    class="nav-link d-flex align-items-center gap-2 text-white">
                                    <i class="fas fa-file-alt"></i>Salidas
                                </a>
                            </li>
                        </ul>
                        <hr style="color: white;">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h1 class="h2">Generar PDF de Orden de Salida</h1>
                </div>
                    ...
                    <div class="table-responsive small">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="cliente" name="cliente"
                                ...
                                value="<?php echo htmlspecialchars($requisicion_data['cliente']); ?>">
                        </div>    
                        <div class="mb-3">
                            <label class="form-label label-large">Usuario</label>
                            <input type="text" class="form-control" id="usuario" name="usuario"
                                aria-describedby="emailHelp"
                                value="<?php echo htmlspecialchars($requisicion_data['usuario']); ?>">
                        </div>
                        <div class="mb-3">
                            <label class="form-label label-large">Fecha de Entrega</label>
                            <input type="text" class="form-control" id="fecha_de_entrega" name="fecha_de_entrega"
                                aria-describedby="emailHelp"
                                value="<?php echo htmlspecialchars($requisicion_data['fecha_de_entrega']); ?>">
                        </div>
                        <div class="mb-3">
                            <label class="form-label label-large">Número de Salida</label>
                            <input type="text" class="form-control" id="numero_de_salida" name="numero_de_salida"
                                aria-describedby="emailHelp"
                                value="<?php echo htmlspecialchars($requisicion_data['numero_de_salida']); ?>">
                        </div>

                        <div class="mb-3" style="display: none;">
                            <label class="form-label label-large">Id del CLIENTE</label>
                            <input type="text" class="form-control" id="idClienteSM" name="idClienteSM"
                                aria-describedby="emailHelp"
                                value="<?php echo htmlspecialchars($requisicion_data['idClienteSM']); ?>" required>
                        </div>
                        ...
                        <div id="partidas-container">
                            <?php foreach ($partidas as $index => $partida): ?>
                                <div class="partida mb-3">
                                    ...
                                    <input type="hidden" name="partidas[<?php echo $index; ?>][id]"
                                        value="<?php echo htmlspecialchars($partida['id']); ?>">
                                    <div class="mb-3">
                                        <label class="form-label label-large">Cantidad</label>
                                        <input type="number" class="form-control" id="cantidad"
                                            name="partidas[${partidaIndex}][cantidad]" aria-describedby="emailHelp"
                                            value="<?php echo htmlspecialchars($partida['cantidad']); ?>" >
                                    </div>
                                    <br>
                                    <div class="input-group">
                                        <span class="input-group-text label-large">Descripción</span>
                                        <textarea class="form-control" id="descripcion"
                                            name="partidas[<?php echo $index; ?>][descripcion]" aria-describedby="emailHelp"
                                            rows="2"><?php echo htmlspecialchars($partida['descripcion']); ?></textarea>
                                    </div>
                                    <br>
                                    <div class="mb-3">
                                        <label class="form-label label-large">Requisición</label>
                                        <input type="text" class="form-control" id="requisicion_id"
                                            name="partidas[<?php echo $index; ?>][requisicion_id]"
                                            aria-describedby="emailHelp"
                                            value="<?php echo htmlspecialchars($partida['requisicion_id']); ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label label-large">Orden de Trabajo</label>
                                        <input type="text" class="form-control" id="orden_de_trabajo"
                                            name="partidas[<?php echo $index; ?>][orden_de_trabajo]"
                                            aria-describedby="emailHelp"
                                            value="<?php echo htmlspecialchars($partida['orden_de_trabajo']); ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label label-large">Control de Calidad</label>
                                        <input type="text" class="form-control" id="control_de_calidad"
                                            name="partidas[<?php echo $index; ?>][control_de_calidad]"
                                            aria-describedby="emailHelp"
                                            value="<?php echo htmlspecialchars($partida['control_de_calidad']); ?>">
                                    </div>
