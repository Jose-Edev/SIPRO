...
// Capturar el parámetro requisicion de la URL
$partidas = $bd->getPartidasByRequisicionId2($requisicion_id);
...
<head>
    ...
    <script src="../../../js/pdfReqs.js"></script>
                ...
                <form id="form">
                    <div class="table-responsive small">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="cotizacion" name="cotizacion" aria-describedby="emailHelp" value="<?php echo htmlspecialchars($requisicion_data['cotizacion']); ?>">
                        </div>
                        <div class="mb-3">
                            <label class="form-label label-large">Requisición</label>
                            <input type="text" class="form-control" id="requisicion_id" name="requisicion_id" aria-describedby="emailHelp" value="<?php echo htmlspecialchars($requisicion_data['requisicion_id']); ?>">
                        </div>
                        <div class="mb-3">
                            <label class="form-label label-large">Fecha</label>
                            <input type="date" class="form-control" id="fecha" name="fecha" aria-describedby="emailHelp" value="<?php echo htmlspecialchars($requisicion_data['fecha']); ?>">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label class="form-label label-large">Fecha de envio de cotización</label>
                            <input type="date" class="form-control" id="fecha_envio" name="fecha_envio" aria-describedby="emailHelp" value="<?php echo htmlspecialchars($requisicion_data['fecha_envio']); ?>">
                        </div>
                        <div class="mb-3">
                            <label class="form-label label-large">Factura</label>
                            <input type="text" class="form-control" id="factura" name="factura" aria-describedby="emailHelp" value="<?php echo htmlspecialchars($requisicion_data['factura']); ?>">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3" style="display: none;">
                            ...
                            <input type="text" class="form-control" id="idClienteSM" name="idClienteSM" aria-describedby="emailHelp" value="<?php echo htmlspecialchars($requisicion_data['idClienteSM']); ?>" required>
                        </div>
                            ...
                            <?php foreach ($partidas as $index => $partida) : ?>
                                <div class="partida mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="num_partida" name="partidas[${partidaIndex}][num_partida]" aria-describedby="emailHelp" value="<?php echo htmlspecialchars($partida['num_partida']); ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label label-large">Cantidad</label>
                                        <input type="number" class="form-control" id="cantidad" name="partidas[${partidaIndex}][cantidad]" aria-describedby="emailHelp" value="<?php echo htmlspecialchars($partida['cantidad']); ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label label-large">Unidad de Medida</label>
                                        <input type="text" class="form-control" id="u_m" name="partidas[<?php echo $index; ?>][u_m]" aria-describedby="emailHelp" value="<?php echo htmlspecialchars($partida['u_m']); ?>">
                                    </div>
                                    <br>
                                    <div class="input-group">
                                        <span class="input-group-text label-large">Descripción</span>
                                        <textarea class="form-control" id="descripcion" name="partidas[<?php echo $index; ?>][descripcion]" aria-describedby="emailHelp" rows="2"><?php echo htmlspecialchars($partida['descripcion']); ?></textarea>
                                    </div>
                                    <br>
                                    <div class="mb-3">
                                        <label class="form-label label-large">Orden de Trabajo</label>
                                        <input type="text" class="form-control" id="orden_trabajo" name="partidas[<?php echo $index; ?>][orden_trabajo]" aria-describedby="emailHelp" value="<?php echo htmlspecialchars($partida['orden_trabajo']); ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label label-large">Orden de Salida</label>
                                        <input type="text" class="form-control" id="orden_salida" name="partidas[<?php echo $index; ?>][orden_salida]" aria-describedby="emailHelp" value="<?php echo htmlspecialchars($partida['orden_salida']); ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label label-large">Ganancia Ingreso</label>
                                        <input type="text" class="form-control" id="ganancia_ingreso" name="partidas[<?php echo $index; ?>][ganancia_ingreso]" aria-describedby="emailHelp" value="<?php echo htmlspecialchars($partida['ganancia_ingreso']); ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label label-large">Precio</label>
                                        <input type="text" class="form-control" id="precio" name="partidas[<?php echo $index; ?>][precio]" aria-describedby="emailHelp" value="<?php echo htmlspecialchars($partida['precio']); ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label label-large">Ganancia Porcentaje</label>
                                        <input type="text" class="form-control" id="ganancia_porcentaje" name="partidas[<?php echo $index; ?>][ganancia_porcentaje]" aria-describedby="emailHelp" value="<?php echo htmlspecialchars($partida['ganancia_porcentaje']); ?>">
                                    </div>
