        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Requisiciones por Empresa</h1>
                ...
                <div class="table-responsive small">
                    <table class="table table-bordered" style="border: #85878a">
                        ...
                        <?php
                        $bd->showRequisiciones($idClienteSM);
                        ?>
                    </table>
                </div>
            </main>
    ...
    <script>
        document.querySelectorAll('.imprimir-partida').forEach(button => {
            button.addEventListener('click', function() {
                ...
                window.location.href = `GenerarPDF/ImprimirRequisicion.php?requisicion_id=${requisicionId}&id=${partidaId}`;
            });
        });
    </script>
