        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Salidas por Empresa</h1>
    ...
    <script>
        document.querySelectorAll('.imprimir-partida').forEach(button => {
            button.addEventListener('click', function() {
                ...
                const partidaId = this.getAttribute('data-id-partida');
                window.location.href = `GenerarPDF/ImprimirSalida.php?requisicion_id=${requisicionId}&id=${partidaId}`;
            });
        });
    </script>
