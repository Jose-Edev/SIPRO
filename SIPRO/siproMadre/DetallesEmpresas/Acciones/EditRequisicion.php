    ...
    <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">Editar Requisición</h1>
        </div>

        <form action="metodos/EditarRequisicion.php" method="post" enctype="multipart/form-data">
          <div class="table-responsive small">

            <div class="mb-3" style="display: none;">
              <label class="form-label label-large">Requisicion oculta</label>
              ...
              <?php foreach ($partidas as $index => $partida) : ?>
                <div class="partida mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="partidas[<?php echo $index; ?>][ganancia_ingreso]" aria-describedby="emailHelp" value="<?php echo htmlspecialchars($partida['ganancia_ingreso']); ?>">
                  </div>

                  <div class="mb-3">
                    <label class="form-label label-large">Ganancia Porcentaje</label>
                    <input type="text" class="form-control" name="partidas[<?php echo $index; ?>][ganancia_porcentaje]" aria-describedby="emailHelp" value="<?php echo htmlspecialchars($partida['ganancia_porcentaje']); ?>">
                  </div>
