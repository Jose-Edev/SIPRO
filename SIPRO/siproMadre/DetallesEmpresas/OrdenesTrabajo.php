...
require_once '../../php/conexion.php'; // Ajusta el path según tu estructura de carpetas

// Obtén el valor de idClienteSM de la URL
$idClienteSM = isset($_GET['cliente']) ? intval($_GET['cliente']) : 0;
...
<head>
    ...
    <style>
        ...
        .table .description {
            white-space: normal;
            /* Permite que el texto se rompa en varias líneas */
            max-width: 350px;
        ...
        @media (max-width: 768px) {
            ...
            .table .description {
                max-width: 350px;
                /* Ajusta el ancho máximo de la descripción en pantallas pequeñas */
            }
        }
        ...
        .nested-table th,
        .nested-table tr:not(:last-child) {
            border-bottom: 1px solid #85878a;
        }

        /* Para ocultar el borde derecho de la última columna */
        .nested-table tr td:last-child,
        .nested-table tr th:last-child {
            border-right: none;
        }

        /* Para ocultar el borde inferior de la última fila */
...
<body>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Órdenes de Trabajo por Empresa</h1>
                    <div class="btn-toolbar mb-2 mb-md-0">
                    </div>
                </div>

                <div class="col-auto">
                    <input style="width: 30%;" class="form-control" type="text" name="buscador" id="buscador" placeholder="Buscar...">
                </div>
                <br>

                <h2></h2>
                <div class="table-responsive small">
                    <table class="table table-bordered" style="border: #85878a">
                        <thead>
                        ...
                        <?php
                        $bd->showOrdenesTrabajo($idClienteSM);
                        ?>
                    </table>
                </div>
            </main>
    ...
    <script>
        document.querySelectorAll('.imprimir-partida').forEach(button => {
            button.addEventListener('click', function() {
                const requisicionId = this.getAttribute('data-requisicion-id');
                const id = this.getAttribute('data-orden-trabajo');
                window.location.href = `GenerarPDF/ImprimirOrdenTrabajo.php?requisicion_id=${requisicionId}&id=${id}`;
            });
        });
    </script>
