...
<head>
  ...
  <style>
    ...
    .containerCli {
      ...
      border-radius: 25px;
      box-shadow: 0 4px 8px rgba(153, 153, 153, 0.9);
      padding: 15px;
      height: 100%;
    }

    .image-text-containerCli {
      display: flex;
  ...
  <div class="container-fluid">
    <div class="row">
      <div style="background-color: #141414;" class="border-left col-md-3 col-lg-2 p-0">
        <div style="width: auto; background-color: #141414;" class="offcanvas-md offcanvas-start me-3" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel"><!-- Esto a poner a todos -->
          ...
          <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto" style="background-color: #141414;">
            <ul class="nav nav-pills flex-column">
              ...
              <li>
              <?php if($usuario === "Oficina" || $usuario === "AdminSipro"): ?>
            ...
            <ul class="nav nav-pills flex-column">
              ...
              <li>
                <a href="EmpresasDetalles.php" style="background-color: red;" class="nav-link d-flex align-items-center gap-2 text-white">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          ...
          <div class="btn-toolbar mb-2 mb-md-0">
            ...
            <?php if($usuario === "Oficina" || $usuario === "AdminSipro"): ?>
              <a href="AddCliente.php"><button type="submit" class="btn btn-success">Agregar Cliente</button></a>
              <?php endif; ?>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <div class="row g-4">
            <!-- Inicio de cada carta -->
            <!-- <div class="col-12 col-md-6">
              <div class="containerCli w3-mobile">
                <div class="row g-0">
                  <div class="col-12 col-md-6">
                    <div class="image-text-containerCli">
                      <img src="../img/alteck Re.jpeg" alt="">
                      <p class="h5">Altec Fluidos</p>
                    </div>
                  </div>
                  <div class="col-12 col-md-6">
                    <div class="button-containerCli">
                      <button type="button" style="background-color: #2eb82e" class="btn btn-success w-100 mb-2">Requisiciones</button>
                      <button type="button" style="background-color: #e60000" class="btn btn-danger w-100 mb-2">Ordenes de Trabajo</button>
                      <button type="button" style="background-color: #e6b800; color: white" class="btn btn-warning w-100 mb-2">Ordenes de Compra</button>
                      <button type="button" style="background-color: #0066ff" class="btn btn-primary w-100 mb-2">Salidas</button>
                    </div>
                  </div>
                </div>
              </div>
