    ...
    <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">Agregar Cliente en Sipro Madre</h1>
        </div>

        <form action="DetallesEmpresas/Acciones/metodos/agregarClienteSM.php" method="post" enctype="multipart/form-data">
          <div class="table-responsive small">
            ...
            <br>
            <div>
              <label for="formFileLg" class="form-label">Logotipo</label>
