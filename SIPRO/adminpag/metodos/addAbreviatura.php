...
if($_SESSION['admin'] === "Almacen" || $_SESSION['admin'] === "Ventas"){
    header('Location: ../siproAdmin.php');
  }
        ...
        <div class="row">
                ...
                <div style="width: auto; background-color: #141414;" class="offcanvas-md offcanvas-start me-3"
                    ...
                    <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto"
                        ...
                        <ul class="nav nav-pills flex-column">
                            <li class="nav-item">
                                <a href="../siproAdmin.php" class="nav-link d-flex align-items-center gap-2 text-white"
                                    aria-current="page">
                                    <i class="fas fa-home"></i> Inicio
                                </a>
                            </li>
                            <li>
                                <a href="../clientes.php" class="nav-link d-flex align-items-center gap-2 text-white">
                                    <i class="fas fa-user"></i> Administrar Clientes
                                </a>
                            </li>
                            <li>
                                <a href="../trabajo.php" class="nav-link d-flex align-items-center gap-2 text-white">
                        ...
                        <ul class="nav nav-pills flex-column">
                            <li>
                                <a href="../abreviaturas.php" style="background-color: red;"
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h1 class="h2">Agregar Abreviatura de Cliente</h1>
                </div>

                <form action="agregarAbreviatura.php" method="post" enctype="multipart/form-data">
                    <div>
                        <div class="mb-3">
                            <label class="form-label label-large">Nombre del Cliente</label>
                            <select name="nombre" id="nombre" class="form-select"
                                aria-label="Default select example" aria-describedby="emailHelp">
                                <!-- Aqui va la funcion -->
                                <?php
                                $options = $bd->getClientesSMOptions2();
                                echo $options;
                                ?>
                            </select>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="abreviatura" name="abreviatura"
                                aria-describedby="emailHelp" placeholder="Abreviatura para el cliente" required>
                        </div>
                        <br>
                        <button type="submit" class="btn btn-success">Agregar Abreviatura de Cliente</button>
                    </div>
                </form>
            </main>
        </div>
