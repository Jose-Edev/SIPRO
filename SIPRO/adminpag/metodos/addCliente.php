...
<head>
  ...
  <style>
    ...
    .offcanvas-md {
      height: 91.95vh; /* Altura del 100% del viewport */
    }

    .offcanvas-body {
      height: calc(100vh - 50px); /* Altura del 100% del viewport menos la altura del encabezado del sidebar */
      overflow-y: auto; /* Agregar scroll vertical si el contenido excede la altura */
    }

    main {
      min-height: calc(100vh - 56px); /* Altura mínima del 100% del viewport menos la altura de la barra de navegación */
    }
        ...
        <div style="width: auto; background-color: #141414;" class="offcanvas-md offcanvas-start me-3" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
          ...
          <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto" style="background-color: #141414;">
            <ul class="nav nav-pills flex-column">
              ...
              <li>
                <a href="../clientes.php" style="background-color: red;" class="nav-link d-flex align-items-center gap-2 text-white">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="table-responsive small">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="nombre" name="nombre" aria-describedby="emailHelp" placeholder="Nombre del cliente" required>  
          </div>
          <br>
          <div>
            ...
            <div id="emailHelp" class="form-text">Solo se admiten archivos jpg, png, gif y jpeg</div>
          </div>
          <br>
