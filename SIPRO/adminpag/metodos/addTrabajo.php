    ...
    <div class="row">
        ...
        <div style="width: auto; background-color: #141414;" class="offcanvas-md offcanvas-start me-3" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
          ...
          <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto" style="background-color: #141414;">
            <ul class="nav nav-pills flex-column">
              <li class="nav-item">
                <a href="../siproAdmin.php" class="nav-link d-flex align-items-center gap-2 text-white" aria-current="page">
              ...
              <li>
                <a href="../trabajo.php" style="background-color: red;" class="nav-link d-flex align-items-center gap-2 text-white">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">Agregar Trabajo</h1>
        </div>

        <form action="agregarTrabajo.php" method="post" enctype="multipart/form-data">
          <div class="table-responsive small">
            <div class="mb-3">
              <label for="exampleInputEmail1" class="form-label">Nombre</label>
              <input type="text" class="form-control" id="nombre" name="nombre" aria-describedby="emailHelp" placeholder="Nombre del trabajo" required>
            </div>
            <br>
            <div class="input-group">
              <span class="input-group-text">Descripcion</span>
              <textarea class="form-control" id="imgdescripcion" name="imgdescripcion" rows="2" placeholder="Inserta una descripcion aqui" ></textarea>
            </div>
            <br>
            <div class="mb-3">
              <label for="exampleInputEmail1" class="form-label">Tipo de archivo</label>
              <select class="form-select" aria-label="Default select example" id="tipo" name="tipo" aria-describedby="emailHelp" required>
            ...
            <div>
              ...
              <div id="emailHelp" class="form-text">Solo se admiten archivos jpg, png, gif, jpeg, mp4 y mkv de 50MB de tamaño.</div>
            </div>
            <br>
