    ...
    <div class="row">
        ...
        <div style="width: auto; background-color: #141414;" class="offcanvas-md offcanvas-start me-3" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
          ...
          <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto" style="background-color: #141414;">
            <ul class="nav nav-pills flex-column">
              <li class="nav-item">
                <a href="siproAdmin.php" style="background-color: red;" class="nav-link d-flex align-items-center gap-2 active" aria-current="page">
            ...
            <ul class="nav nav-pills flex-column">
              <li>
                <a href="../siproMadre/sipromadre.php" class="nav-link d-flex align-items-center gap-2 text-white">
                  <img src="../img/carpeta blanca con logo sin fondo.png" alt="iconCarpSIPRO" style="width: 33px; margin-left: -8px;">SIPRO Madre
                </a>
              </li>
              <li>
                <a href="../siproMadre/EmpresasDetalles.php" class="nav-link d-flex align-items-center gap-2 text-white">
            ...
            <ul class="nav nav-pills flex-column">
              <li>
              <?php if($usuario === "Oficina" || $usuario === "AdminSipro"): ?>
                <a href="abreviaturas.php" class="nav-link d-flex align-items-center gap-2 text-white">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <?php
          if($usuario === "Oficina" || $usuario === "Almacen"){
            echo '<h1 class="h2">Bienvenida ' . $_SESSION['user'] . '</h2>';
          }else{
            echo '<h1 class="h2">Bienvenido ' . $_SESSION['user'] . '</h2>';
          }
          ?>
        </div>
        <h2>Administración</h2>
        <div>
          <img style="width: 100%;" src="../img/collage (1).png" alt="collage de imagenes">
        </div>
      </main>
    </div>
  </div>
