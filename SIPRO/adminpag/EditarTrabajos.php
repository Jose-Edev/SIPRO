      ...
      <div class="row">
          ...
          <div style="width: auto; background-color: #141414;" class="offcanvas-md offcanvas-start me-3" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
            ...
            <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto" style="background-color: #141414;">
              <ul class="nav nav-pills flex-column">
                ...
                <li>
                  <a href="../adminpag/
                  trabajo.php" style="background-color: red;" class="nav-link d-flex align-items-center gap-2 text-white">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Editar Trabajo Seleccionado</h1>
          </div>

          <form action="metodos/updateTrabajos.php" method="post" enctype="multipart/form-data">
            <input type="hidden" id="idTrabajo" name="idTrabajo" value="<?php echo $idTrabajo; ?>">
            <div class="table-responsive small">
              ...
              <div class="input-group">
                ...
                <textarea class="form-control" id="descripcion" name="descripcion" rows="2" placeholder="Inserta una descripcion aqui" ></textarea>
              </div>
              <br>
              <div class="mb-3">
